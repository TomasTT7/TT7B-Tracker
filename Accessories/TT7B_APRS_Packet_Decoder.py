# EXAMPLE:
# !/5LD\S*,yO[0W?[%)Bxe`$V.>B!1dGK#NR15MHWS(KY"`8RvuF6K?[%)Bxe`$V.>B!1dGK
...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.port_label_1.grid(row=40, column=0, sticky=W, pady=5)
        self.port_label_2 = Label(self, text="_____________________________")
        self.port_label_2.grid(row=40, column=1, sticky=W)
        self.port_label_3 = Label(self, text="_______________")
        self.port_label_3.grid(row=40, column=2, sticky=W)
        self.port_label_4 = Label(self, text="_______________")
        self.port_label_4.grid(row=40, column=3, sticky=W)
        self.port_label_5 = Label(self, text="________")
        self.port_label_5.grid(row=40, column=4, sticky=W)
        ...
        self.altitudeP_label.grid(row=16, column=1, sticky=W)
        self.altitudeP_value = Label(self, text="")
        self.altitudeP_value.grid(row=16, column=2, sticky=W)

        self.data1_value2 = Label(self, text="")
        self.data1_value2.grid(row=16, column=3, sticky=W)

        self.sats_label = Label(self, text="Satellites:")
        self.sats_label.grid(row=17, column=1, sticky=W)
        self.sats_value = Label(self, text="")
        self.sats_value.grid(row=17, column=2, sticky=W)

        self.time_label = Label(self, text="Active Time:")
        self.time_label.grid(row=18, column=1, sticky=W)
        self.time_value = Label(self, text="")
        self.time_value.grid(row=18, column=2, sticky=W)

        self.res_label = Label(self, text="Last Reset:")
        self.res_label.grid(row=19, column=1, sticky=W)
        self.res_value = Label(self, text="")
        self.res_value.grid(row=19, column=2, sticky=W)

        self.out_label2 = Label(self, text="BACKLOG")
        self.out_label2.grid(row=20, column=0, sticky=W, padx=5)
        self.out_label2_2 = Label(self, text="")
        self.out_label2_2.grid(row=20, column=2, sticky=W, columnspan=2)

        self.latitudeB_label = Label(self, text="Latitude:")
        self.latitudeB_label.grid(row=21, column=1, sticky=W)
        self.latitudeB_value = Label(self, text="")
        self.latitudeB_value.grid(row=21, column=2, sticky=W)
        self.latitudeB_value2 = Label(self, text="")
        self.latitudeB_value2.grid(row=21, column=3, sticky=W)

        self.longitudeB_label = Label(self, text="Longitude:")
        self.longitudeB_label.grid(row=22, column=1, sticky=W)
        self.longitudeB_value = Label(self, text="")
        self.longitudeB_value.grid(row=22, column=2, sticky=W)
        self.longitudeB_value2 = Label(self, text="")
        self.longitudeB_value2.grid(row=22, column=3, sticky=W)

        self.altitudePB_label = Label(self, text="Altitude precise:")
        self.altitudePB_label.grid(row=23, column=1, sticky=W)
        self.altitudePB_value = Label(self, text="")
        self.altitudePB_value.grid(row=23, column=2, sticky=W)

        self.data2_value2 = Label(self, text="")
        self.data2_value2.grid(row=23, column=3, sticky=W)

        self.satsB_label = Label(self, text="Satellites:")
        self.satsB_label.grid(row=24, column=1, sticky=W)
        self.satsB_value = Label(self, text="")
        self.satsB_value.grid(row=24, column=2, sticky=W)
        
        self.resB_label = Label(self, text="Last Reset:")
        self.resB_label.grid(row=25, column=1, sticky=W)
        self.resB_value = Label(self, text="")
        self.resB_value.grid(row=25, column=2, sticky=W)

        self.yearB_label = Label(self, text="Year:")
        self.yearB_label.grid(row=26, column=1, sticky=W)
        self.yearB_value = Label(self, text="")
        self.yearB_value.grid(row=26, column=2, sticky=W)

        self.data3_value2 = Label(self, text="")
        self.data3_value2.grid(row=26, column=3, sticky=W)

        self.monthB_label = Label(self, text="Month:")
        self.monthB_label.grid(row=27, column=1, sticky=W)
        self.monthB_value = Label(self, text="")
        self.monthB_value.grid(row=27, column=2, sticky=W)

        self.dayB_label = Label(self, text="Day:")
        self.dayB_label.grid(row=28, column=1, sticky=W)
        self.dayB_value = Label(self, text="")
        self.dayB_value.grid(row=28, column=2, sticky=W)

        self.hourB_label = Label(self, text="Hour:")
        self.hourB_label.grid(row=29, column=1, sticky=W)
        self.hourB_value = Label(self, text="")
        self.hourB_value.grid(row=29, column=2, sticky=W)

        self.minuteB_label = Label(self, text="Minute:")
        self.minuteB_label.grid(row=30, column=1, sticky=W)
        self.minuteB_value = Label(self, text="")
        self.minuteB_value.grid(row=30, column=2, sticky=W)

        self.timeB_label = Label(self, text="Active Time:")
        self.timeB_label.grid(row=31, column=1, sticky=W)
        self.timeB_value = Label(self, text="")
        self.timeB_value.grid(row=31, column=2, sticky=W)

        self.tempMCUB_label = Label(self, text="Temperature MCU:")
        self.tempMCUB_label.grid(row=32, column=1, sticky=W)
        self.tempMCUB_value = Label(self, text="")
        self.tempMCUB_value.grid(row=32, column=2, sticky=W)
        self.tempMCUB_value2 = Label(self, text="")
        self.tempMCUB_value2.grid(row=32, column=3, sticky=W)

        self.tempTH1B_label = Label(self, text="Temperature THERMISTOR_1:")
        self.tempTH1B_label.grid(row=33, column=1, sticky=W)
        self.tempTH1B_value = Label(self, text="")
        self.tempTH1B_value.grid(row=33, column=2, sticky=W)
        self.tempTH1B_value2 = Label(self, text="")
        self.tempTH1B_value2.grid(row=33, column=3, sticky=W)

        self.tempTH2B_label = Label(self, text="Temperature THERMISTOR_2:")
        self.tempTH2B_label.grid(row=34, column=1, sticky=W)
        self.tempTH2B_value = Label(self, text="")
        self.tempTH2B_value.grid(row=34, column=2, sticky=W)
        self.tempTH2B_value2 = Label(self, text="")
        self.tempTH2B_value2.grid(row=34, column=3, sticky=W)

        self.tempMS1B_label = Label(self, text="Temperature MS5607_1:")
        self.tempMS1B_label.grid(row=35, column=1, sticky=W)
        self.tempMS1B_value = Label(self, text="")
        self.tempMS1B_value.grid(row=35, column=2, sticky=W)
        self.tempMS1B_value2 = Label(self, text="")
        self.tempMS1B_value2.grid(row=35, column=3, sticky=W)

        self.tempMS2B_label = Label(self, text="Temperature MS5607_2:")
        self.tempMS2B_label.grid(row=36, column=1, sticky=W)
        self.tempMS2B_value = Label(self, text="")
        self.tempMS2B_value.grid(row=36, column=2, sticky=W)
        self.tempMS2B_value2 = Label(self, text="")
        self.tempMS2B_value2.grid(row=36, column=3, sticky=W)

        self.presMS1B_label = Label(self, text="Pressure MS5607_1:")
        self.presMS1B_label.grid(row=37, column=1, sticky=W)
        self.presMS1B_value = Label(self, text="")
        self.presMS1B_value.grid(row=37, column=2, sticky=W)
        self.presMS1B_value2 = Label(self, text="")
        self.presMS1B_value2.grid(row=37, column=3, sticky=W)

        self.presMS2B_label = Label(self, text="Pressure MS5607_2:")
        self.presMS2B_label.grid(row=38, column=1, sticky=W)
        self.presMS2B_value = Label(self, text="")
        self.presMS2B_value.grid(row=38, column=2, sticky=W)
        self.presMS2B_value2 = Label(self, text="")
        self.presMS2B_value2.grid(row=38, column=3, sticky=W)

        self.battVB_label = Label(self, text="Battery Voltage:")
        self.battVB_label.grid(row=39, column=1, sticky=W)
        self.battVB_value = Label(self, text="")
        self.battVB_value.grid(row=39, column=2, sticky=W)
        self.battVB_value2 = Label(self, text="")
        self.battVB_value2.grid(row=39, column=3, sticky=W)
    ...
    def decode(self):
        ...
        if  content[0] is '!' and (len(content) is 36 or len(content) is 71):
            ...
            tempMCU = 29.8 + ((tempMCU * (-10 + ((-10 - (-10)) * ((29.8 + ((tempMCU - 2847 * (-10)) * (84.9 - 29.8)) \
                    / (3324 * (-10) - 2847 * (-10))) - 29.8)) / (84.9 - 29.8)) - 2847 * (-10)) * (84.9 - 29.8)) / (3324 * (-10) -2847 * (-10))
            ...
            data1 = self.Base91_4(content[32:36])
            ...
            self.data1_value2.config(text=content[32:36])

            if len(content) is 71:
                latitudeB = self.Base91_4(content[36:40])
                latitudeB = 90.0 - latitudeB / 380926.0
                self.latitudeB_value.config(text='{0:.5f}'.format(latitudeB) + u"\u00b0")
                self.latitudeB_value2.config(text=content[36:40])

                longitudeB = self.Base91_4(content[40:44])
                longitudeB = longitudeB / 190463.0 - 180.0
                self.longitudeB_value.config(text='{0:.5f}'.format(longitudeB) + u"\u00b0")
                self.longitudeB_value2.config(text=content[40:44])

                data2 = self.Base91_4(content[44:48])
                ...
                self.data2_value2.config(text=content[44:48])

                data3 = self.Base91_5(content[48:53])
                ...
                self.data3_value2.config(text=content[48:53])

                tempMCUB = self.Base91_2(content[53:55])
                tempMCUB = 29.8 + ((tempMCUB * (-10 + ((-10 - (-10)) * ((29.8 + ((tempMCUB - 2847 * (-10)) * (84.9 - 29.8)) \
                        / (3324 * (-10) - 2847 * (-10))) - 29.8)) / (84.9 - 29.8)) - 2847 * (-10)) * (84.9 - 29.8)) / (3324 * (-10) -2847 * (-10))
                self.tempMCUB_value.config(text='{0:.2f}'.format(tempMCUB) + u"\u2103")
                self.tempMCUB_value2.config(text=content[53:55])

                tempTH1B = self.Base91_2(content[55:57])
                ...
                self.tempTH1B_value2.config(text=content[55:57])

                tempTH2B = self.Base91_2(content[57:59])
                ...
                self.tempTH2B_value2.config(text=content[57:59])

                tempMS1B = self.Base91_2(content[59:61])
                tempMS1B = (tempMS1B - 4000.0) / 50.0
                self.tempMS1B_value.config(text='{0:.2f}'.format(tempMS1B) + u"\u2103")
                self.tempMS1B_value2.config(text=content[59:61])

                tempMS2B = self.Base91_2(content[61:63])
                tempMS2B = (tempMS2B - 4000.0) / 50.0
                self.tempMS2B_value.config(text='{0:.2f}'.format(tempMS2B) + u"\u2103")
                self.tempMS2B_value2.config(text=content[61:63])

                presMS1B = self.Base91_3(content[63:66])
                self.presMS1B_value.config(text='{0:.0f}'.format(presMS1B) + "Pa")
                self.presMS1B_value2.config(text=content[63:66])
                
                presMS2B = self.Base91_3(content[66:69])
                self.presMS2B_value.config(text='{0:.0f}'.format(presMS2B) + "Pa")
                self.presMS2B_value2.config(text=content[66:69])

                battVB = self.Base91_2(content[69:71])
                battVB = battVB / 4095.0 * 1.826 / 0.5
                self.battVB_value.config(text='{0:.3f}'.format(battVB) + "V")
                self.battVB_value2.config(text=content[69:71])
